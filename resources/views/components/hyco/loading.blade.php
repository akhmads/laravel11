<div>
    <div class="fixed top-[82px] z-[9999] left-1/2 -translate-x-1/2 inline-flex item-center bg-sky-50 text-sky-700 border border-sky-200 px-10 py-3 rounded-lg text-sm">

        {{-- <svg width="24" height="24" class="mr-3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="text-sky-800 mr-3" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
